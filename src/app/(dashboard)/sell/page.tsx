  ...
  return (
    <div className="max-w-xl mx-auto space-y-6 pt-4 pb-16">
      <div>
        ...
        <h1 className="text-2xl sm:text-3xl font-bold text-[#161412] tracking-tight">فروش موجودی و تسویه آنی</h1>
      ...
      <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-[#E8E2D7] shadow-subtle space-y-6">
        ...
        <div className="flex items-center justify-between p-4 bg-[#FAF8F4] rounded-2xl border border-[#E8E2D7]">
          <div>
            <span className="text-[10px] text-[#7E776C] block mb-0.5 font-semibold uppercase">نرخ خرید زروی از شما (هر گرم ۱۸ عیار)</span>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-xs font-bold text-[#161412] mb-1.5">وزن طلای قابل فروش (گرم)</label>
          ...
          <div className="p-4 bg-[#FAF8F4] rounded-2xl border border-[#E8E2D7] space-y-2 text-xs">
            <div className="flex justify-between items-center text-[#4A453E]">
              ...
              <span className="font-num font-bold text-base text-[#14182E]">{toPersianDigits(formatNumber(computedAmount))} تومان</span>
            </div>
            <div className="flex justify-between items-center text-[#7E776C] text-[11px]">
