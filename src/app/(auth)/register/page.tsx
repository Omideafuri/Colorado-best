        ...
        <div className="bg-[#3A230A] p-6 sm:p-8 rounded-2xl sm:rounded-3xl border border-white/15 shadow-floating-umber">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs font-bold text-[#EEE9C1] mb-1.5">نام</label>
                <div className="relative">
                  <input
                    name="firstName"
                    type="text"
                    placeholder="آرش"
                    className="w-full rounded-xl border border-white/15 bg-[#231506] px-3.5 py-3 text-xs sm:text-sm text-white placeholder:text-white/30 focus:border-[#A4530C] outline-none"
                    required
                  />
              ...
              <div>
                <label className="block text-xs font-bold text-[#EEE9C1] mb-1.5">نام خانوادگی</label>
                <input
                  name="lastName"
                  type="text"
                  placeholder="امینی"
            ...
            <div>
              <label className="block text-xs font-bold text-[#EEE9C1] mb-1.5">رمز عبور (حداقل ۸ کاراکتر)</label>
              <div className="relative">
                <input
                  name="password"
                  type="password"
            ...
            <div>
              <label className="block text-xs font-bold text-[#EEE9C1] mb-1.5">تکرار رمز عبور</label>
              <input
          ...
          <div className="mt-6 pt-5 border-t border-white/10 text-center text-xs text-[#DDD7B5]">
            ...
            <Link href="/login" className="font-bold text-[#EEE9C1] hover:text-white hover:underline">
              ورود اعضا
            </Link>
          </div>
        </div>
